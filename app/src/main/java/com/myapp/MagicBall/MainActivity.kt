...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        askButton.setOnClickListener { choseAnswer() }
    }

    fun choseAnswer() {
        val rnd = Random().nextInt(20) + 1
        val imageChosen = when (rnd) {
        ...
        imgView.setImageResource(imageChosen)
        //
